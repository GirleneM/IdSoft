...
public class Jogo9 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Jogo9 frame = new Jogo9(String, String, String, String, String, String, String, String, String, String);
	 ...
	 * Create the frame.
	 */
	public Jogo9(String dificuldade, String questao, String resposta, String altA, String altB, String altC, String altD, String idQuestao, String idUser, String nomeUser) {
		setTitle("Javalingo - Nona Questão " + dificuldade);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(resposta.equals("A")){
					...
					if(QuestaoDAO.NovaQuestao){
						...
						Jogo10 j10 = new Jogo10(dificuldade, questao.getQuestao(), questao.getResposta(),
