...
public class Jogo3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Jogo3 frame = new Jogo3(String, String, String, String, String, String, String, String, String, String);
	 ...
	 * Create the frame.
	 */
	public Jogo3(String dificuldade, String questao, String resposta, String altA, String altB, String altC, String altD, String idQuestao, String idUser, String nomeUser) {
		setTitle("Javalingo - Terceira Questão " + dificuldade);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(resposta.equals("A")){
					...
					if(QuestaoDAO.NovaQuestao){
						...
						Jogo4 j4 = new Jogo4(dificuldade, questao.getQuestao(), questao.getResposta(),
