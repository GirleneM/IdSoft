...
public class Jogo4 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Jogo4 frame = new Jogo4(String, String, String, String, String, String, String, String, String, String);
	 ...
	 * Create the frame.
	 */
	public Jogo4(String dificuldade, String questao, String resposta, String altA, String altB, String altC, String altD, String idQuestao, String idUser, String nomeUser) {
		setTitle("Javalingo - Quarta Questão " + dificuldade);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(resposta.equals("A")){
					...
					if(QuestaoDAO.NovaQuestao){
						...
						Jogo5 j5 = new Jogo5(dificuldade, questao.getQuestao(), questao.getResposta(),
