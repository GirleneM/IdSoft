...
public class Tutorial extends JFrame {
	...
	public Tutorial(String nomeUser, String idUser) {
		...
		lblFundo.setIcon(new ImageIcon(Tutorial.class.getResource("/com/javalingo/img/Imagens/livro9.jpg")));
