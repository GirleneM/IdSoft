...
public class Jogo1 extends JFrame {
/**
	 * 
	 */
...
int erradas =0;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Jogo1 frame = new Jogo1(String, String, String, String, String, String, String, String, String, String);
	 ...
	 * Create the frame.
	 */
	public Jogo1(String dificuldade, String questao, String resposta, String altA, String altB, String altC, String altD, String idQuestao, String idUser, String nomeUser) {
		setTitle("Javalingo - Primeira  Questão " + dificuldade);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(resposta.equals("A")){
					...
					if(QuestaoDAO.NovaQuestao){
						...
						Jogo2 j2 = new Jogo2(dificuldade, questao.getQuestao(), questao.getResposta(),
