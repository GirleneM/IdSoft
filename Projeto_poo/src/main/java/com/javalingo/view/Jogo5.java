...
public class Jogo5 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Jogo5 frame = new Jogo5(String, String, String, String, String, String, String, String, String, String);
	 ...
	 * Create the frame.
	 */
	public Jogo5(String dificuldade, String questao, String resposta, String altA, String altB, String altC, String altD, String idQuestao, String idUser, String nomeUser) {
		setTitle("Javalingo - Quinta Questão " + dificuldade);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(resposta.equals("A")){
					...
					if(QuestaoDAO.NovaQuestao){
						...
						Jogo6 j6 = new Jogo6(dificuldade, questao.getQuestao(), questao.getResposta(),
